...
//vkex::Result IInstance::LoadFunctionSetLookups(InstanceFunctionSetLookUp* p_look_up)
//{
//  if (p_look_up == nullptr) {
//    return vkex::Result::ErrorUnexpectedNullPointer;
//  }
//
//  if (!IsFunctionSetLoaded()) {
//    return vkex::Result::ErrorFunctionSetNotLoaded;
//  }
//
//  //
//  // Add key for VkInstance object so vkex::* functions taking 
//  // VkInstance are callable from here on out.
//  //
//  p_look_up->Add(m_vk_object, this);
//
//  // Add keys using physical devices
//  std::vector<const void*> keys;
//  {
//    // vkex::EnumeratePhysicalDevices should be callable since 
//    // VkInstance object was added above.
//    std::vector<VkPhysicalDevice> vk_physical_devices;
//    VkResult vk_result = InvalidValue<VkResult>::Value;
//    VKEX_VULKAN_RESULT_CALL(
//      vk_result,
//      vkex::EnumeratePhysicalDevices(
//        m_vk_object,
//        &vk_physical_devices)
//    );
//    if (vk_result != VK_SUCCESS) {
...
//      keys.push_back(vk_physical_device);
//    }
//  }
//
//  p_look_up->Add(keys, this);
//
//  return vkex::Result::Success;
//}
...
)
{
  ...
  // Log instance creation
  {
    ...
    // Extensions
    if (m_vk_create_info.enabledExtensionCount > 0) {
      VKEX_LOG_INFO("Instance extensions loaded:");
