...
std::string ToString(const VkApplicationInfo& application_info, const vkex::TextFormat& format)
{
    ...
    std::string indent = format.block_indent + sw;
    ss << indent << "sType"
       << " = " << ToString(application_info.sType) << vkex::k_new_line;
    ss << indent << "pNext"
       << " = " << ToPointerAddressString(application_info.pNext) << vkex::k_new_line;
    ss << indent << "pApplicationName"
       << " = " << ToString(application_info.pApplicationName) << vkex::k_new_line;
    ss << indent << "applicationVersion"
       << " = " << ToString(application_info.applicationVersion) << vkex::k_new_line;
    ss << indent << "pEngineName"
       << " = " << ToString(application_info.pEngineName) << vkex::k_new_line;
    ss << indent << "engineVersion"
       << " = " << ToString(application_info.engineVersion) << vkex::k_new_line;
    ss << indent << "apiVersion"
       << " = " << ToStringVulkanApiVersion(application_info.apiVersion) << vkex::k_new_line;
...
std::string ToString(const VkInstanceCreateInfo& create_info, const vkex::TextFormat& format)
{
    ...
    std::string indent = format.block_indent + sw;
    ss << indent << "sType"
       << " = " << ToString(create_info.sType) << vkex::k_new_line;
    ss << indent << "pNext"
       << " = " << ToPointerAddressString(create_info.pNext) << vkex::k_new_line;
    ss << indent << "pApplicationInfo"
       << " = " << ToString(*create_info.pApplicationInfo, application_info_format) << vkex::k_new_line;
    ss << indent << "enabledLayerCount"
       << " = " << create_info.enabledLayerCount << vkex::k_new_line;
    ss << indent << "ppEnabledLayerNames"
       << " = " << ToArrayString(create_info.enabledLayerCount, create_info.ppEnabledLayerNames, array_format) << vkex::k_new_line;
    ss << indent << "enabledExtensionCount"
       << " = " << create_info.enabledExtensionCount << vkex::k_new_line;
    ss << indent << "ppEnabledExtensionNames"
       << " = " << ToArrayString(create_info.enabledExtensionCount, create_info.ppEnabledExtensionNames, array_format) << vkex::k_new_line;
...
std::string ToString(const VkDeviceQueueCreateInfo& create_info, const vkex::TextFormat& format)
{
    ...
    ss << indent << "pNext"
       << " = " << ToPointerAddressString(create_info.pNext) << vkex::k_new_line;
    ss << indent << "flags"
       << " = " << ToStringVkDeviceQueueCreateFlags(create_info.flags) << vkex::k_new_line;
    ss << indent << "queueFamilyIndex"
       << " = " << create_info.queueFamilyIndex << vkex::k_new_line;
    ss << indent << "queueCount"
       << " = " << create_info.queueCount << vkex::k_new_line;
    ss << indent << "pQueuePriorities"
       << " = " << ToArrayString(create_info.queueCount, create_info.pQueuePriorities, array_format) << vkex::k_new_line;
...
std::string ToString(const VkDeviceCreateInfo& create_info, const vkex::TextFormat& format)
{
    ...
    ss << indent << "pNext"
       << " = " << ToPointerAddressString(create_info.pNext) << vkex::k_new_line;
    ss << indent << "flags"
       << " = " << ToStringVkDeviceCreateFlags(create_info.flags) << vkex::k_new_line;
    ss << indent << "queueCreateInfoCount"
       << " = " << create_info.queueCreateInfoCount << vkex::k_new_line;
    ss << indent << "pQueueCreateInfos"
       << " = " << ToArrayString(create_info.queueCreateInfoCount, create_info.pQueueCreateInfos, queue_array_format) << vkex::k_new_line;
    ss << indent << "enabledLayerCount"
       << " = " << create_info.enabledLayerCount << vkex::k_new_line;
    ss << indent << "ppEnabledLayerNames"
       << " = " << ToArrayString(create_info.enabledLayerCount, create_info.ppEnabledLayerNames, array_format) << vkex::k_new_line;
    ...
    ss << indent << "ppEnabledExtensionNames"
       << " = " << ToArrayString(create_info.enabledExtensionCount, create_info.ppEnabledExtensionNames, array_format) << vkex::k_new_line;
    ss << indent << "pEnabledFeatures"
       << " = " << ToString(*create_info.pEnabledFeatures, feature_format) << vkex::k_new_line;
...
std::string ToString(const VkSwapchainCreateInfoKHR& create_info, const vkex::TextFormat& format)
{
    ...
    ss << indent << "pNext"
       << " = " << ToPointerAddressString(create_info.pNext) << vkex::k_new_line;
    ss << indent << "flags"
       << " = " << ToStringVkSwapchainCreateFlags(create_info.flags) << vkex::k_new_line;
    ss << indent << "surface"
       << " = " << ToVkHandleAddressString(create_info.surface) << vkex::k_new_line;
    ss << indent << "minImageCount"
       << " = " << create_info.minImageCount << vkex::k_new_line;
    ss << indent << "imageFormat"
       << " = " << ToString(create_info.imageFormat) << vkex::k_new_line;
    ss << indent << "imageColorSpace"
       << " = " << ToString(create_info.imageColorSpace) << vkex::k_new_line;
    ss << indent << "imageExtent"
       << " = " << ToString(create_info.imageExtent) << vkex::k_new_line;
    ss << indent << "imageArrayLayers"
       << " = " << create_info.imageArrayLayers << vkex::k_new_line;
    ss << indent << "imageUsage"
       << " = " << ToStringVkImageUsageFlags(create_info.imageUsage) << vkex::k_new_line;
    ss << indent << "imageSharingMode"
       << " = " << ToString(create_info.imageSharingMode) << vkex::k_new_line;
    ss << indent << "queueFamilyIndexCount"
       << " = " << create_info.queueFamilyIndexCount << vkex::k_new_line;
    ss << indent << "pQueueFamilyIndices"
       << " = " << ToArrayString(create_info.queueFamilyIndexCount, create_info.pQueueFamilyIndices, array_format) << vkex::k_new_line;
    ss << indent << "preTransform"
       << " = " << ToString(create_info.preTransform) << vkex::k_new_line;
    ss << indent << "compositeAlpha"
       << " = " << ToString(create_info.compositeAlpha) << vkex::k_new_line;
    ss << indent << "presentMode"
       << " = " << ToString(create_info.presentMode) << vkex::k_new_line;
    ss << indent << "clipped"
       << " = " << ToStringVkBool32(create_info.clipped) << vkex::k_new_line;
    ss << indent << "oldSwapchain"
       << " = " << ToVkHandleAddressString(create_info.oldSwapchain) << vkex::k_new_line;
