...
inline void DebugMarkerBegin(VkCommandBuffer cmd_buffer, const char* marker_name, const glm::vec4& color = glm::vec4(1, 1, 1, 1))
{
...
{
public:
    DebugMarkerHelper(VkCommandBuffer cmd_buffer, const char* marker_name, const glm::vec4& color = glm::vec4(1, 1, 1, 1))
    {
